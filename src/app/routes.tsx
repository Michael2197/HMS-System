...
const routes = [
  ...
  { path: '/husbandry/overview', element: <Husbandry />, moduleKey: 'husbandry' },
  { path: '/marketing/overview', element: <Marketing />, moduleKey: 'marketing' },
  { path: '/procurement/overview', element: <Procurement />, moduleKey: 'procurement' },
